package org.xm.xmnlp.model.maxent;
    ...
    public static MaxEntModel create(String path) {
        ...
        try {
            ...
            for (int i = 0; i < numOutcomes; i++) {
                ...
                TextUtil.writeString(outcomeLabels[i], out);
            }
            // pattern
            ...
            for (int i = 0; i < NUM_PREDS; i++) {
                ...
                TextUtil.writeString(predLabels[i], out);
            ...
            logger.severe("从" + path + "加载最大熵模型失败！" + TextUtil.exceptionToString(e));
            return null;
        }
        return m;
    }
