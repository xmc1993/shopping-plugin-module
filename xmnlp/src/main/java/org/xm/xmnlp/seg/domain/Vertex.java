...
public class Vertex {
     ...
     * 始##始
     */
    public static Vertex B = new Vertex(Predefine.TAG_BEGIN, " ", new CoreDictionary.Attribute(Nature.begin, Predefine.MAX_FREQUENCY / 10), CoreDictionary.getWordID(Predefine.TAG_BEGIN));
    /**
     * 末##末
     */
...
//                break;
    ...
    public static Vertex newB() {
        return new Vertex(Predefine.TAG_BEGIN, " ", new CoreDictionary.Attribute(Nature.begin, Predefine.MAX_FREQUENCY / 10), CoreDictionary.getWordID(Predefine.TAG_BEGIN));
    }
