...
public class PlaceDictionary {
    ...
    static {
        ...
        dictionary.load(Xmnlp.Config.PlaceDictionaryPath);
        logger.info(Xmnlp.Config.PlaceDictionaryPath + "加载成功，耗时" + (System.currentTimeMillis() - start) + "ms");
        transformMatrixDictionary = new TransformMatrixDictionary<NS>(NS.class);
        transformMatrixDictionary.load(Xmnlp.Config.PlaceDictionaryTrPath);
